...
<body>
    <form action="db_code/signin.php" method="POST">
        <section class="image">
            <div class="logo_contain">
                <img src="img/head/logo3.png" alt="ftd" class="logo logo_login">
                <p>Вход</p>
            <div class="logo_div">
                <input type="text" class="logo_input" placeholder="Login" id="login">
                <input type="password" class="logo_input" placeholder="Password" id="pass">
